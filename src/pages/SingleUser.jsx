      ...
      <div className="w-full mx-auto lg:w-10/12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 mb-8 md:gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="w-full rounded-lg shadow-md bg-base-100 stats grid grid-rows-2">
              {location && (
                <div className="stat">
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats grid grid-rows-2">
          <div className="stat">
